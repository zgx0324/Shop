...
<div class="zl-header">
    <div class="zl-hd w1200">
        ...
        <p class="hd-p2 f-r">
            ...
            <a href="${pageContext.request.contextPath}/user/personal.do">个人中心</a><span>|</span>
            <a href="${pageContext.request.contextPath}/order/toBasket.do">我的购物车</a><span>|</span>
            <a href="${pageContext.request.contextPath}/order/toMyOrder.do">我的订单</a>
        </p>
...
<div class="payment w1200">
    ...
    <div class="payment-bd">
        <dl class="dl-hd">
            ...
            <dt><a href="${pageContext.request.contextPath}/product/productDetail.do?pid=${orderItemExt.pid}"><img src="${pageContext.request.contextPath}/images/in-matong3.gif" /></a></dt>
            <dd>
                <h3><a href="${pageContext.request.contextPath}/product/productDetail.do?pid=${orderItemExt.pid}">${orderItemExt.product.pName}</a></h3>
            </dd>
            </c:forEach>
            <div style="clear:both;"></div>
        </dl>
        <ul class="ul-bd">
            <li><span>送货至</span><p>${fn:split(address.addr,"-")[0]}  ${fn:split(address.addr,"-")[1]} </p></li>
            <li><span>价格</span><p><i>¥${orderExt.total}</i></p></li>
            <li><span>卖家名称</span><p>爱尚自营店</p></li>
            <li><span>收货信息</span><p>${address.addr}， ${address.name}， ${address.tel}</p></li>
            <li><span>成交时间</span><p>${orderExt.date}</p></li>
            <li><span>订单号</span><p>${orderExt.orderNumber}</p></li>
        </ul>
    </div>
    <div class="payment-ft">
        <button class="btn2" id="btn2">我的订单</button>
    </div>
</div>
