...
<div class="sign-con w1200">
    ...
    <div class="sign-ipt f-l">
        <form id="form" action="${pageContext.request.contextPath}/doLogin.do" method="post">
            <p>用户名</p>
            <input type="text" id="userName" name="userName" placeholder="手机号/邮箱" onfocus="this.value = '';"/>
            <p>密码</p>
            <input type="text" id="passWord" name="passWord" placeholder="密码可见" onfocus="this.value = '';"/><br/>
            <span style="color: #E90000">${msg}</span>
            <input type="checkbox" name="remember" value="remember" style="width:15px;height:15px;margin-top:2px" ${empty cookie.passWord.value? "":"checked"}>记住密码
            <button type="button" class="slig-btn" id="sub">登录</button>
            <p>没有账号？请<a href="${pageContext.request.contextPath}/register.do">注册</a><a href="#" class="wj">忘记密码？</a></p>
            <div class="sign-qx">
