    ...
    <div class="nav-kuai w1200">
        <div class="nav-kuaijie yjp-hover1 f-l">
            ...
            <div class="kuaijie-box yjp-show1" style="display:none;">
                ...
                <div class="kuaijie-info">
                    <dl class="kj-dl1">
                        <dt><img src="images/zl2-08.gif" /><a href="搜索列表(有品牌).html">粮油副食</a></dt>
                        <dd>
                ...
                <div class="kuaijie-info">
                    <dl class="kj-dl1">
                        <dt><img src="images/zl2-09.gif" /><a href="搜索列表(有品牌).html">家庭清洁</a></dt>
                        <dd>
                ...
                <div class="kuaijie-info">
                    <dl class="kj-dl1">
                        <dt><img src="images/zl2-10.gif" /><a href="搜索列表(有品牌).html">美妆洗护/个人护理</a></dt>
                        <dd>
                ...
                <div class="kuaijie-info">
                    <dl class="kj-dl1">
                        <dt><img src="images/zl2-11.gif" /><a href="搜索列表(有品牌).html">母婴用品/玩具</a></dt>
                        <dd>
                ...
                <div class="kuaijie-info">
                    <dl class="kj-dl1">
                        <dt><img src="images/zl2-12.gif" /><a href="搜索列表(有品牌).html">家居/家电</a></dt>
                    </dl>
                    <div class="kuaijie-con">
                        <dl class="kj-dl2">
                            <dt><a href="搜索列表(有品牌).html">洗浴用品/身体护理</a></dt>
